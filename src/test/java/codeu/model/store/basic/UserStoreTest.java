...
public class UserStoreTest {
  ...
  private final User USER_ONE =
      new User(UUID.randomUUID(), "test_username_one", "test_pw_one", Instant.ofEpochMilli(1000));
  private final User USER_TWO =
      new User(UUID.randomUUID(), "test_username_two", "test_pw_two", Instant.ofEpochMilli(2000));
  private final User USER_THREE =
      new User(UUID.randomUUID(), "test_username_three", "test_pw_three", Instant.ofEpochMilli(3000));
